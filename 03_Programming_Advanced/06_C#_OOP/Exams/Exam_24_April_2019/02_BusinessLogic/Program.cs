    ...
    public class StartUp
    {
        public static void Main()
        {
            ...
            while (true)
            {
                ...
                {
                    string name = inputArr[1];
                    double attack = double.Parse(inputArr[2]);
                    double defense = double.Parse(inputArr[3]);
                ...
                {
                    string pilotName = inputArr[1];
                    string machineName = inputArr[2];
                    Console.WriteLine(manager.EngageMachine(pilotName, machineName));
                }
                else if (inputArr[0] == "Attack")
                {
                    string attackingMachine = inputArr[1];
                    string defendingMachine = inputArr[2];
                    Console.WriteLine(manager.AttackMachines(attackingMachine, defendingMachine));
                }
