	function Story_CharacterCreationTest2() {
		...
		game_stext = '<br>'
				   + '<div id="story_charactercreationtest1" class="game_simg"></div>'
		 		   + '<br>'   
				   + '<p>The autumnal equinox is exactly 2 days from now! It symbolises a time of balance in old tradition, as this is when the day and night are perfectly equal. However I have no idea what this "Feast Day" may be.</p>'
		 		   + '<br>'
				   + '<p>"The Feast Day is a time of balance... AND harvest... Meaning that in the past they did some rituals the days before... Now leave me alone, im bussy! *he yells, which makes you jump.*"</p>'
				   + '<br>'
		 		   + '<p>You say quietly, too light a tone to actually do anything, so you raise your hand and call her, with the faintest hint of a smile on your lips. You sound satisfied. You are really proud of your work and for a first time you have this feeling that everything was going to be alright... or was it really?</p>'
		 		   + '<br>'
	...
	function Story_CharacterCreationTest3() {
		...
		game_stext = '<br>'
				   + '<div id="story_charactercreationtest4" class="game_simg"></div>'
		 		   + '<br>'
				   + `<p>The teacher slowly approached, while the following words slipped out of your mouth, <span class="player">"Fine... ill come"</span>, you answer, thinking at how his deal feel just as shady as everything else that this guy does. Tonight is a special night, you must be careful as too many factors are coming into play already and you just told him that you will go with him. However, saying that you will go and actually going is a totally different thing, yet you can't imagine what he might do to you later if you just outstraight lied to him. You must make up your mind before tonight.</p>`
		 		   + '<br>'
