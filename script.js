function Story_CharacterCreationTest2() {
	...
	game_stext = '<br>'
			   ...
			   + '<div id="story_charactercreationtest2" class="game_simg"></div>'
	 		   + '<br>'
	 		   + `<p><span class="player">"Good job {name}, seems like you put a lot of work in there!"</span>, a rather familiar, but disturbing voice complimented me in a seemingly friendly manner, however I already knew who <i>he</i> was and anxiety stroke me hard, as I swiftly turned backwards to confirm it. It was him, {name}!... but when did he get behind me. Was he planning to torture me again? Was tommorow's bullying not enough for him? Couldn't he just leave me alone for once!</p>`
	 		   + '<br>'
	 		   + `<p><span class="player">"There's no need to get so tense {name}. In fact, I would like to make you a deal"</span>, he said with a confident, seemingly friendly disposition, but the determined posture of someone who knows exactly what they want. You could only narrow your eyes as you looked at him, but you knew him well enough to trust a single word comming out of his mouth. <span class="player">"What do you want {name}?</span>, you ask him, unable to look him straight into his eyes. <span class="player">"If this is about the coffe, I already promised to fix my mistake and buy the proper one.</span>, you tell him, feeling your pulse quicken as you recognize the threat he was to you.</p>`
	 		   + '<br>'
